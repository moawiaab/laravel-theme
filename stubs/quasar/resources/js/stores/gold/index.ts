import { Golds } from '@/types/columns';
...
export const useGoldsIndex = defineStore("gold-store", {
    state: () => ({
        entry: <Unit>{},
        lists: {
            roles: [],
        ...
        storeData() {
            ...
            return new Promise(async (resolve, reject) => {
                await axios
                    ...
                    .then((response) => {
                        Notify.create({
                            message: "تم إضافة فاتورة الذهب بنجاح",
                            type: 'positive',
        ...
        updateData(id : number) {
            ...
            return new Promise(async (resolve, reject) => {
                await axios
                    ...
                    .then((response) => {
                        Notify.create({
                            message: "تم تعديل بيانات فاتورة الذهب بنجاح",
                            type: 'positive',
