...
const headers: import("vue3-easy-data-table").Header[] = [
	{ text: "g.user_name", value: "name", width: 200, sortable: true, fixed: true },
	{ text: "g.email", value: "email", width: 200 },
	{ text: "g.phone_number", value: "phone", sortable: true },
	{ text: "input.role.name", value: "role", sortable: true },
	{ text: "input.account.name", value: "account" },
